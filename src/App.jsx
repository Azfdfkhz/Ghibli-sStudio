...
export default function App() {
  ...
  return (
    <div
      className={`flex min-h-screen overflow-hidden transition-colors duration-1000 ${
        darkMode
    ...
    >
      ...
      {/* Main Content Area - tanpa margin, biar natural */}
      <div className="flex-1 flex flex-col lg:pb-0 pb-16 overflow-hidden">
        <Routes>
          {/* Halaman Utama */}
          <Route
            path="/"
